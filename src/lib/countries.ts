// Auto-generated from restcountries.com — name, ISO-3166 alpha-2 code, dial code.
...
export const COUNTRIES: Country[] = [
  ...
  { name: "French Southern and Antarctic Lands", code: "TF", dial: "+262" },
  ...
  { name: "Pitcairn Islands", code: "PN", dial: "+64" },
  ...
  { name: "Saint Helena, Ascension and Tristan da Cunha", code: "SH", dial: "+2" },
  ...
  { name: "South Georgia", code: "GS", dial: "+500" },
  ...
  { name: "Svalbard and Jan Mayen", code: "SJ", dial: "+4779" },
  ...
  { name: "United States Minor Outlying Islands", code: "UM", dial: "+268" },
  { name: "United States Virgin Islands", code: "VI", dial: "+1340" },
  { name: "Uruguay", code: "UY", dial: "+598" },
  { name: "Uzbekistan", code: "UZ", dial: "+998" },
  { name: "Vanuatu", code: "VU", dial: "+678" },
  { name: "Vatican City", code: "VA", dial: "+3" },
  { name: "Venezuela", code: "VE", dial: "+58" },
  { name: "Vietnam", code: "VN", dial: "+84" },
  { name: "Wallis and Futuna", code: "WF", dial: "+681" },
  { name: "Western Sahara", code: "EH", dial: "+2" },
  { name: "Yemen", code: "YE", dial: "+967" },
  { name: "Zambia", code: "ZM", dial: "+260" },
  { name: "Zimbabwe", code: "ZW", dial: "+263" },
  { name: "Åland Islands", code: "AX", dial: "+35818" },
];

// Map ISO alpha-2 code -> regional-indicator flag emoji (no images/API needed).
...
// "CO" -> "🇨🇴 Colombia". Falls back to the raw value if it's not a known code.
export function countryLabel(value: string | null | undefined): string {
  if (!value) return "—";
  const c = BY_CODE.get(value);
  return c ? `${flagEmoji(c.code)} ${c.name}` : value;
}
