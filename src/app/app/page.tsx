  ...
  return (
    <div className="flex flex-col gap-8">
      ...
      <div className="grid gap-4 sm:grid-cols-4">
        ...
        <div className="rounded-xl border border-zinc-200 bg-white p-5">
          <p className="text-[11px] font-semibold uppercase tracking-widest text-zinc-400">Growth Potential</p>
          <p className="mt-3 text-4xl font-bold text-zinc-900">{fmtCurrency(growthRevenue)}</p>
          <p className="mt-1 text-xs text-zinc-400">+{growthUnits} avatars in existing clients</p>
        </div>
        <div className="rounded-xl border border-zinc-200 bg-white p-5">
